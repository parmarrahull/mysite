...
const Myskill = () => {
    ...
    return (
        <>
            <h1 className='my-10 flex justify-center text-5xl  font-medium'>
                My skill in different languages
            </h1>
            <div className='flex justify-center text-slate-400 text-2xl'>
                <p className='flex text-center py-5 w-2/3'> Currently, I'm working on node js (backend) technology,
            ...
            <div className='flex justify-center  gap-10 mt-10'>
                {skill.map((data) => {
                    return (
                        <>
                            <div className='w-4/12 py-8 rounded shadow-2xl px-5'>
